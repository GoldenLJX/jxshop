...
<head>
	...
	<script type="text/javascript" src="/Public/Home//Public/Home/js/cart1.js"></script>
	...
	<div class="mycart w990 mt10 bc">
		...
		<table>
			...
			<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
					<td class="col1"><a href=""><img src="/<?php echo ($vo["goods"]["goods_thumb"]); ?>" alt="" /></a>  <strong><a href=""><?php echo ($vo["goods_name"]); ?></a></strong></td>
					<td class="col2">
