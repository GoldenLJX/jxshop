...
<head>
	...
	<script type="text/javascript" src="/Public/Home//Public/Home/js/jquery-1.8.3.min.js"></script>
	<script type="text/javascript" src="/Public/Home//Public/Home/js/header.js"></script>
	<script type="text/javascript" src="/Public/Home//Public/Home/js/goods.js"></script>
	<script type="text/javascript" src="/Public/Home//Public/Home/js/jqzoom-core.js"></script>
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="/<?php echo ($pic["0"]["goods_img"]); ?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="/<?php echo ($pic["0"]["goods_img"]); ?>" alt="" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
						...
						<div class="smallpic_wrap">
							<ul>
								<?php if(is_array($pic)): $i = 0; $__LIST__ = $pic;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li <?php if(($i) == "1"): ?>class="cur"<?php endif; ?> >
									<a <?php if(($i) == "1"): ?>class="zoomThumbActive"<?php endif; ?> href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'images/preview_m1.jpg',largeimage: 'images/preview_l1.jpg'}"><img src="/<?php echo ($vo["goods_img"]); ?>"></a>
